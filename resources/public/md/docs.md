...
Two middleware functions are provided by default in the `jaredbowiev2.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `jaredbowiev2.handler` namespace to manage the enabled middleware.
